        ...
        return (
          <ProductButton
            ...
            click={() =>
              this.setState({
                showModal: true,
                updatedProduct: product.product_name,
    ...
    return (
      <div className="container" style={{ margin: 10 }}>
        <ButtonToolbar style={{ justifyContent: "center", display: "flex" }}>
          <Button onClick={this.showAllProducts}>
            <Refresh /> Show All
          </Button>
        ...
        {this.state.showModal ? (
          <div className="static-modal">
            <Modal.Dialog style={{ overflowY: "initial" }}>
              ...
              <Modal.Body
                style={{ textAlign: "left", overflowY: "auto", height: 500 }}
              >
...
const mapDispatchToProps = (dispatch) => {
  return {
    incrementQuantity: (productID, quantity) =>
      dispatch(actionTypes.incrementQuantity(productID, quantity)),
    updateQuantity: (product_name, productID, quantity) =>
      dispatch(actionTypes.updateQuantity(product_name, productID, quantity)),
