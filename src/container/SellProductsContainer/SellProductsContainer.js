...
class ProductButtons extends Component {
  ...
  refreshProducts = () => {
    ...
    axios({
      ...
      let products_list = response.data;
      const products_list_rev = products_list.reverse();
      console.log("inside refresh products");
      console.log(products_list_rev);
      this.props.updateProducts(products_list_rev);
    });
  };
  ...
  filterCategory = (category_id) => {
    axios({
      ...
      let productsArr = response.data.filter(
  ...
  render() {
    console.log("inside Sellproducts render");
    ...
    return (
      <div className="container" style={{ margin: 10 }}>
        ...
        {this.state.showWomensCategory ? (
          <ButtonToolbar style={{ justifyContent: "center", display: "flex" }}>
            <Button onClick={() => this.filterCategory(8)}>
              Women's T-Shirts
            </Button>
            <Button onClick={() => this.filterCategory(9)}>
              Women's Tank Tops
            </Button>
            <Button onClick={() => this.filterCategory(10)}>
              Women's Hoodies
            </Button>
            <Button onClick={() => this.filterCategory(11)}>
              Women's Jackets
            </Button>
            <Button onClick={() => this.filterCategory(12)}>
              Women's Shorts
            </Button>
            <Button onClick={() => this.filterCategory(13)}>
              Women's Hats
            </Button>
            <Button onClick={() => this.filterCategory(14)}>
              Women's Socks
            </Button>
          </ButtonToolbar>
        ) : null}
        {this.state.showKidsCategory ? (
          <ButtonToolbar style={{ justifyContent: "center", display: "flex" }}>
            <Button onClick={() => this.filterCategory(15)}>
              Kids' T-Shirts
            </Button>
            <Button onClick={() => this.filterCategory(16)}>
              Kids' Hoodies
            </Button>
            <Button onClick={() => this.filterCategory(17)}>Kids' Pants</Button>
            <Button onClick={() => this.filterCategory(18)}>
              Kids' Shorts
            </Button>
          </ButtonToolbar>
        ) : null}
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    updateProducts: (category_id) =>
      dispatch(actionTypes.editProduct(category_id)),
  };
};
